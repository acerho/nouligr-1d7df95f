      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            View notification history and configure SMS settings
          </p>
        </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="mt-1 text-muted-foreground">
                      SMS integration with Twilio is planned for a future update. 
                      Notifications are currently logged for reference.
                    </p>
                  </div>
                </div>
              </div>
              ...
              {logs.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">
                    Notifications will appear here when appointment statuses change
                  </p>
                </div>
              ) : (
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-start justify-between gap-2">
                          <div>
                            ...
                            {log.patient && (
                              <p className="text-sm text-muted-foreground">
                                Patient: {(log.patient as any).first_name} {(log.patient as any).last_name}
                              </p>
                            )}
                          </div>
